              ...
              <motion.div>
                <div className="space-y-2 mb-8">
                  <p className="text-sm text-muted-foreground text-center">
                    Hozir {users.length} ta foydalanuvchi online!
                  </p>
                  {users.length <= 1 && (
                    <p className="text-xs font-mono text-muted-foreground text-center text-yellow-600">
                      (Bu xususiyat — xatolik emas!
                      <br /> Do&apos;stlaringizni taklif qiling!)
                    </p>
                  )}
                </div>
                <motion.ul
                ...
                <div key={i}>
                  <span>
                    <span
                      ...
                      className="mr-2"
                    >
                      {msg.username} {msg.socketId === socket?.id && "(siz)"}:
                    </span>
        ...
        {isEditingName ? (
          ...
          <>
            <span className="text-sm">
              {user.name} {user.socketId === socket?.id && "(siz)"}
            </span>
